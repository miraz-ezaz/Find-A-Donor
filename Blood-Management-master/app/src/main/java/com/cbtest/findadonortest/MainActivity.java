...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Find A Donor");
        ...
        userRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    nav_fullname.setText("Name: "+ name);
                    ...
                    nav_type.setText("User Type: " + type.toUpperCase());
                    ...
                    {
                        nav_menu.findItem(R.id.donationStatus).setVisible(false);
                    }
    ...
    // read donors in the same region as the user

    private void readLocalDonor(String region){
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference()
                .child("users");

        Query query = reference.orderByChild("searchRegion").equalTo("donor"+region);
...
// Navigate to different activity
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.savedUser:
                Intent intent11 = new Intent(MainActivity.this,SavedUserActivity.class);
                startActivity(intent11);
                break;

            case R.id.viewReceipient:
                Intent intent16 = new Intent(MainActivity.this,ViewRecipientActivity.class);
                startActivity(intent16);
                break;

            case R.id.sentRequest:
                Intent intent12 = new Intent(MainActivity.this,SentRequestActivity.class);
                startActivity(intent12);
                break;

            case R.id.receivedRequest:
                Intent intent13 = new Intent(MainActivity.this,ReceivedRequestActivity.class);
                startActivity(intent13);
                break;

            case R.id.shareLocation:
                Intent intent14 = new Intent(MainActivity.this,ShareLocationActivity.class);
                startActivity(intent14);
                break;

            case R.id.donationStatus:
                Intent intent15 = new Intent(MainActivity.this,UpdateStatusActivity.class);
                startActivity(intent15);
                break;
            case R.id.donorsOther:
                Intent intent17 = new Intent(MainActivity.this,OtherDonorSearch.class);
                startActivity(intent17);
                break;

            case R.id.rcpntOther:
                Intent intent18 = new Intent(MainActivity.this,OtherRecipientSearch.class);
                startActivity(intent18);
                break;

            case R.id.searchPhone:
                Intent intent19 = new Intent(MainActivity.this,SearchPhoneActivity.class);
                startActivity(intent19);
                break;

            case R.id.notification:
                Intent intent20 = new Intent(MainActivity.this,NotificationActivity.class);
