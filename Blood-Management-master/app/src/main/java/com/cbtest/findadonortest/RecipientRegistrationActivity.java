        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(region.equals("Select Your Region")){
                    Toast.makeText(RecipientRegistrationActivity.this,"Select Your Region",Toast.LENGTH_LONG).show();
                    return;
                }
                if(img_set == 0){
                    Toast.makeText(RecipientRegistrationActivity.this, "Select a profile picture", Toast.LENGTH_LONG).show();
                }
                    ...
                    mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                ...
                                userInfo.put("available","never");
                                userInfo.put("region",region);
                                userInfo.put("notification","null");
                                userInfo.put("totaldonation","-1");
                                userInfo.put("lastdonationdate","2022-01-01");
                                userInfo.put("search","recipient"+bloodGroup);
                                userInfo.put("searchAvailable","recipientnever"+bloodGroup);
                                userInfo.put("searchRegion","recipient"+region);
                                userInfo.put("searchRegionGroup","recipient"+region+bloodGroup);
                                userInfo.put("searchRegionAvailable","recipientnever"+region+bloodGroup);
                                userInfo.put("searchStatus","activerecipient"+bloodGroup);
                                userInfo.put("searchStatusRegion","active"+region+"recipient"+bloodGroup);
                                // insert user data in firebase
                                userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                    @Override
                                    public void onComplete(@NonNull Task task) {
                                        if(task.isSuccessful()){
                                            Toast.makeText(RecipientRegistrationActivity.this, "Data set Sucessfully", Toast.LENGTH_SHORT).show();
                                        }
                                        else {
                                                ...
                                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseRef.updateChildren(newimageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if (task.isSuccessful()){
                                                                    Toast.makeText(RecipientRegistrationActivity.this, "Image Url added to databse ", Toast.LENGTH_SHORT).show();
                                                                }
    ...
    private void showRegionSpinner() {
        regionDatabaseReference.child("region").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(RecipientRegistrationActivity.this,R.layout.style_spinner,regionList);
