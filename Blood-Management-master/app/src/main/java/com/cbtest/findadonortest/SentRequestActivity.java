...
public class SentRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestAdapter = new RequestAdapter(SentRequestActivity.this,requestList);
    ...
    private void readRequest() {
        ...
        Query query = reference.orderByChild("senderId").equalTo(FirebaseAuth.getInstance().getCurrentUser().getUid());
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(requestList.isEmpty()){
                    Toast.makeText(SentRequestActivity.this, "No Requests Found", Toast.LENGTH_LONG).show();
                }
