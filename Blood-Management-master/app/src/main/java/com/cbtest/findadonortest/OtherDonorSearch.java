...
public class OtherDonorSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_donor_search);
        ...
        userAdapter = new UserAdapter(OtherDonorSearch.this,userList);
        recyclerView.setAdapter(userAdapter);

        // search donors based on region and blood group
        ...
        searchDonorButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(bloodGroup.equals("Select Your Blood Group")){
                    Toast.makeText(OtherDonorSearch.this,"Select Blood Group",Toast.LENGTH_LONG).show();
                    return;
                }

                if(region.equals("Select Your Region")){
                    Toast.makeText(OtherDonorSearch.this,"Select Your Region",Toast.LENGTH_LONG).show();
                    return;
                }
...
// read region from firebase
    private void showRegionSpinner() {
        regionDatabaseReference.child("region").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(OtherDonorSearch.this,R.layout.style_spinner,regionList);
    ...
    // read users from fireabse based on region
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                DatabaseReference reference = FirebaseDatabase.getInstance().getReference()
                        .child("users");
                Query query = reference.orderByChild("searchRegionGroup").equalTo("donor"+region+group);
                query.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (userList.isEmpty())
                        {
                            donerNumber.setText("No "+group+" Donor Found in "+region);
                        }
                        else
                        {
                            donerNumber.setText((userList.size())+" "+group+" Donor Found in "+region);
                        }
